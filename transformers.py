...
def handle_file_string(file, tokenizer, redis_conn, text_embedding_field, index_name, prefix):
    """
    ...
    try:
        ...
        # print(f'Attempting Redis: {redis_conn}, and index: {index_name}')
        load_vectors(redis_conn, vectors, text_embedding_field, index_name, prefix)
        # print(f'loaded vector to', index_name)
    except Exception as e:
        print(f'Ran into a problem uploading to Redis index {index_name}: {e}')
